...
// Make CRM_{EXT_SHORT_NAME_CAMEL_CASE}_ExtensionUtil available.
require_once __DIR__ . '/../../signatures.civix.php';

// phpcs:disable PSR1.Files.SideEffects

// Add test classes to class loader.
addExtensionDirToClassLoader(__DIR__);
addExtensionToClassLoader('de.systopia.signatures');
 ...
 */
function _signatures_test_civicrm_container(ContainerBuilder $container): void {
}
